...
def categorize_animal_image(path: str):
    """
    Categorizes an animal image based on the path

    @param path: image path
    """
    return img_store.categorize_animal_image(path)

tools.append(generate_json_schema(get_all_files))
tools.append(generate_json_schema(categorize_animal_image))
