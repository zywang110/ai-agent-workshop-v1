...
# TODO: write function that find animals in an image
# hint: you need to rewrite the function name.
# hint: use chatGPT to understand the image [Example API usage](https://platform.openai.com/docs/guides/vision/uploading-and-processing-images)
def to_be_named():
    pass
...
functions = [generate_json_schema(f) for f in [
    # TODO: add tool that find animals in an image
    get_all_files
    ]]
